...
You can use the Trinity's option –full_cleanup in Trinity command to retain only the Trinity.fasta and the gene_trans_map files, since you will be using said information in downstream analyses.
...
# Citation
Please cite: Benítez-Álvarez et al (2023) Phylotranscriptomics interrogation uncovers a complex evolutionary history for the planarian genus Dugesia (Platyhelminthes, Tricladida) in the Western Mediterranean. Molecular Phylogenetics and Evolution. https://doi.org/10.1016/j.ympev.2022.107649
